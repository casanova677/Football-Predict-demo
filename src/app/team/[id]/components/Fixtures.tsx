...
import { ChevronDoubleDownIcon, ChevronDoubleLeftIcon, ChevronDoubleRightIcon } from "@heroicons/react/16/solid"
                            ...
                            firstItemsFixturesFuture.map((fixture, i) => (
                                <Link
                                    ...
                                    className="w-full flex-shrink-0 flex text-neutral-100 items-center h-36
                                     hover:bg-gradient-to-r from-black/40 to-black/20"
                                >
            ...
            <div className="flex flex-col w-full justify-center items-center">
                ...
                }
                {
                    visibleItemsCount < fixturesByTeamId.length && (
                        <div className="p-2">
                            <button
                                className="bg-gradient-to-r from-gray-900/60 to-black/40 p-4"
