...
import FixturesByLeague from "../components/home/FixturesByLeague";
...
export default function StandingsAndFixtures() {
    ...
    const [filteredFixtures, setFixturesData] = useState<AllFixtures[]>([]);
    ...
    const fetchFilteredFixtures = async ()=>{
        try {
            const result = await getFituresForFiveLeagues()
    ...
    const menuItems = ['EPL', 'La Liga', 'Bundesliga','Seria A', 'Ligue 1' ];
    ...
    return (
        <div className="flex flex-col w-full max-w-[69rem] lg:flex-row ">
            <div className="flex justify-center items-center lg:w-3/5 md:p-10 py-5">
                <div className="flex px-2 flex-col justify-center items-center bg-gradient-to-b from-black/40 w-full text-neutral-100 rounded-3xl">
